...
exports.SwipeEventManager = exports.SwipeEventType = void 0;
// Enumerations.
/**
 ...
 * @class
 */
var SwipeEventManager = /** @class */ (function () {
    /**
     * @description Initializes
     * 	event data and build it.
     * @constructor
     */
    function SwipeEventManager(tag, onSwipe) {
     ...
     */
    SwipeEventManager.prototype.getTag = function () {
        // Returns the current
        // tag reference.
        return this.tag_;
    };
     ...
     * @return {void} void
     */
    SwipeEventManager.prototype.free = function () {
        var _a, _b;
     ...
     * @returns {void} void
     */
    SwipeEventManager.prototype.overrideTag_ = function (tag) {
     ...
     * @returns {void} void
     */
    SwipeEventManager.prototype.listen = function (callback) {
     ...
     * @return {void} void
     */
    SwipeEventManager.prototype.setTag = function (tag) {
     ...
     * @returns {void} void
     */
    SwipeEventManager.prototype.swipe_ = function () {
        var _this = this;
        // The swipe direction.
        var swipedir;
    ...
    return SwipeEventManager;
}());
exports.SwipeEventManager = SwipeEventManager;
